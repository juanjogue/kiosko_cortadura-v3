...
// Preflight CORS (algunos navegadores lanzan OPTIONS antes del GET)
...
/* Extracción de la URL: si el cliente la envía ya codificada, $_GET['url'] la
   entrega decodificada (una sola vez). Solo si llega SIN codificar se parsea
   manualmente de la query string. */
$url = '';
